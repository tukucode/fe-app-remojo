      ...
      <Carousel activeIndex={index} onSelect={handleSelect}>
        <Carousel.Item style={styleItem}>
          ...
          <Carousel.Caption>
            ...
            <h1 className="text-subtitle-carousel">Buru diskon menarik disini!</h1>
            <p className="text-caption-carousel">Dapatkan pengalaman renal yang menarik bersama keluarga anda.</p>
          </Carousel.Caption>
        </Carousel.Item>
